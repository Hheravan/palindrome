...
public class PalindromeTest {
	...
	public void testGivenValues(){
		...
		assertEquals("2147447412", findNearestPalindrome(String.valueOf(Integer.MAX_VALUE)));
	}
	@Test
	...
	public void testExceptionCases(){
		findNearestPalindrome(String.valueOf(Long.MAX_VALUE));
		findNearestPalindrome(String.valueOf(Long.MIN_VALUE));
		findNearestPalindrome("-afff333");
		findNearestPalindrome("-1234231A");
	}
}